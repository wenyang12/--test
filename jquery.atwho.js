...
Controller = (function() {
  ...
  Controller.prototype.init = function(setting) {
    this.setting = $.extend({}, this.setting || $.fn.atwhoEmail["default"], setting);
    this.view.init();
...
TextareaController = (function(superClass) {
  ...
  TextareaController.prototype.catchQuery = function() {
    ...
    caretPos = this.$inputor.caretEmail('pos', {
  ...
  TextareaController.prototype.rect = function() {
    ...
    if (!(c = this.$inputor.caretEmail('offset', this.pos - 1, {
      iframe: this.app.iframe
    }))) {
      return;
    }
  ...
  TextareaController.prototype.insert = function(content, $li) {
    ...
    $inputor.val(text);
    $inputor.caretEmail('pos', startStr.length + content.length, {
      iframe: this.app.iframe
    });
    if (!$inputor.is(':focus')) {
      $inputor.focus();
...
EditableController = (function(superClass) {
  ...
  EditableController.prototype._getRange = function() {
    ...
    if (sel.rangeCount > 0) {
      ...
      return this.app.document.createRange();
    }
  };
  ...
  EditableController.prototype.catchQuery = function(e) {
    ...
    if ($query.length === 0 && isString && (index = range.startOffset - this.at.length - matched.length) >= 0) {
      ...
      $query = $('<a/>', this.app.document).attr(this.getOpt("editableAtwhoQueryAttrs")).addClass('atwho-query');
  ...
  EditableController.prototype.insert = function(content, $li) {
    ...
    attr('data-atwho-id',data['id']).
    attr('href','#profile/=/empid-'+data['id']);
    if (range = this._getRange()) {
